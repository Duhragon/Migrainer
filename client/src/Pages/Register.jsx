...
function Register() {
  ...
  return (
    <div className=" min-h-screen md:h-screen p-3 lg:p-5 flex flex-col md:flex-row items-center justify-center bg-bg-primary ">
      ...
      <div className="w-full md:rounded-l-none md:rounded-r-xl md:border-y-2 md:border-l-none border-bg-secondary rounded-b-xl border-x-2 border-b-2 h-full flex items-center justify-center  p-5 overflow-autos">
